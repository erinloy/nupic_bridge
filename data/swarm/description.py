...
control = {
 ...
 u'predictionSteps': [10]},
  ...
  'metrics':[
    MetricSpec(field=u'kw_energy_consumption', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [10], 'errorMetric': 'aae'}),
    MetricSpec(field=u'kw_energy_consumption', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [10], 'errorMetric': 'altMAPE'})
  ],
